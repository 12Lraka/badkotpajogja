...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
                ...
                <div class="navbar-brand-wrapper d-flex w-100">
                    ...
                    <div class="collapse navbar-collapse navbar-menu-wrapper" id="navbarSupportedContent">
                        <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#digital-marketing-section">Ketentuan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#feedback-section">Kandidat</a>
                            </li>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <li>
                                        <form action="/logout" method="POST">
                                            @csrf
                                            <button type="submit" onclick="return confirm('Apakah Anda Yakin ingin logout?')" class="dropdown-item">Logout
                                            </button>
                                        </form>
                                    </li>
                                </ul>
    ...
    <div class="banner">
        <div class="container">
            <h1 class="font-weight-semibold">Pemilihan Ketua Badko TKA TPA Kota Yogyakarta</h1>
            <h6 class="font-weight-normal text-muted pb-3">Sistem Informasi E-Voting Pemilihan Ketua Badko TKA TPA Kota Yogyakarta</h6>
            <div>
                <a href="/login" class="btn btn-opacity-light mr-1">Login</a>
                <button class="btn btn-opacity-success ml-1">Ketentuan</button>
            </div>
        ...
        <div class="container">
            <section class="digital-marketing-service" id="digital-marketing-section">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-7 grid-margin grid-margin-lg-0" data-aos="fade-right">
                        <h3 class="m-0">Ketentuan Umum</h3>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-5 flex-item grid-margin" data-aos="fade-left">
                        <h3 class="m-0">Ketentuan Pemilih</h3>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-7 grid-margin grid-margin" data-aos="fade-right">
                        <h3 class="m-0">Cara Mengikuti Voting !</h3>
                        <h6 class="section-subtitle text-muted m-0"> Bagi yang belum mempunyai akun silahkan menghubungi PANITIA</h6>
                        <div class="col-lg-9 col-xl-8 p-0">
                            <ul class="fa-ul">
                                <p class="py-2 m-0 text-muted">
                                    <li><span class="fa-li"><i class="fa-solid fa-check-square"></i></span>Login</li>
                                    <li><span class="fa-li"><i class="fas fa-check-square"></i></span>Pilih Bilik Suara</li>
                                    <li><span class="fa-li"><i class="fas fa-check-square"></i></span>Pilih Kandidat</li>
                                    <li><span class="fa-li"><i class="fas fa-check-square"></i></span>Klik Tombol Tetapkan Pilihan</li>
                                    <li><span class="fa-li"><i class="fas fa-check-square"></i></span>Selesai</li>
                                </p>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-lg-5 img-digital grid-margin grid-margin" data-aos="fade-left">
                        <img src="/img/Group2.png" alt="" class="img-fluid">
                    </div>
                </div>
            </section>
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    @if ($calon->foto)
                                    <img src="{{ asset('storage/' . $calon->foto) }}" width="89" height="89" alt="" class="img-customer">
                                    @else
            ...
            <section class="contact-us" id="contact-section">
                <div class="contact-us-bgimage grid-margin">
                    <div class="pb-4">
                        <h4 class="px-3 px-md-0 m-0" data-aos="fade-down">Kritik dan Saran Silahkan Menghubungi Kami
                        </h4>
                        <h4 class="pt-1" data-aos="fade-down"></h4>
                    </div>
                    <div data-aos="fade-up">
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-rounded btn-outline-danger">Kontak</button>
                    </div>
                </div>
            </section>
            <footer class="border-top">
                <p class="text-center text-muted pt-4">Copyright © 2022<a href="https://github.com/MuhammadAbdiel" class="px-1">Rongko Laksono.</a>All rights reserved.</p>
