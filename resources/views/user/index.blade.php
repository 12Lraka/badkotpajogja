                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form id="data-{{ $user->username }}" action="/dashboard/user/{{ $user->username }}" method="post">
                                    @method('delete')
                                    @csrf
                                    <button type="submit" class="btn btn-danger p-1 delete" data-nama="{{ $user->nama_pengguna }}" data-username="{{ $user->username }}">
